...
```bash
$ docker build . -t devops4docff/devops-elasticsearch:7.17
$ docker login -u "devops4docff" -p "***" docker.io
$ docker push devops4docff/devops-elasticsearch:7.17
```
...
> https://hub.docker.com/repository/docker/devops4docff/devops-elasticsearch

```bash
$ docker run --rm -d --name elastic -p 9200:9200 -p 9300:9300 devops4docff/devops-elasticsearch:7.17
$ docker ps
CONTAINER ID   IMAGE                                COMMAND                  CREATED          STATUS          PORTS                                            NAMES
5262d69644f7   devops4docff/devops-elasticsearch:7.17   "sh -c ${ES_HOME}/bi…"   7 seconds ago   Up 6 seconds   0.0.0.0:9200->9200/tcp, 0.0.0.0:9300->9300/tcp   elastic
...
total 28
-rw-r--r-- 1 elasticsearch elasticsearch 1422 Mar 4 12:18 index-0
-rw-r--r-- 1 elasticsearch elasticsearch    8 Mar 4 12:18 index.latest
drwxr-xr-x 6 elasticsearch elasticsearch 4096 Mar 4 12:18 indices
-rw-r--r-- 1 elasticsearch elasticsearch 9688 Mar 4 12:18 meta--3PjnnAUQAKLY_SmssKV4g.dat
-rw-r--r-- 1 elasticsearch elasticsearch  452 Mar 4 12:18 snap--3PjnnAUQAKLY_SmssKV4g.dat
```
